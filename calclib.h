...
CALCAPI int		__cdecl calc_print (HCALC h, char *str, int_t options, int binw, int *size);
CALCAPI int		__cdecl calc_print_res (HCALC h, char *str, int_t options, int binw);
CALCAPI char *	__cdecl calc_error (HCALC h);
CALCAPI void	__cdecl calc_addfn (HCALC h, const char* name, void *fn); //(void *)(int (*) (int))fn
CALCAPI int_t	__cdecl calc_get_flags(HCALC h);
CALCAPI void	__cdecl calc_clr_flags(HCALC h);
CALCAPI void	__cdecl calc_set_syntax (HCALC h, int_t syntax);
CALCAPI int_t	__cdecl calc_get_syntax (HCALC h);
