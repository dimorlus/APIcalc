...
float__t Copysign(float__t x, float__t y)
{
...
float__t Erf (float__t x)
{
 ...
 float__t y = (float__t)1.0L - (((((a5 * t + a4) * t) + a3) * t + a2) * t + a1) * t * Exp (-x * x);
...
float__t Erfinv (float__t x)
{
 ...
 const float__t LN2 = 6.931471805599453094172321214581e-1L;

 const float__t A0 = 1.1975323115670912564578e0L;
 const float__t A1 = 4.7072688112383978012285e1L;
 const float__t A2 = 6.9706266534389598238465e2L;
 const float__t A3 = 4.8548868893843886794648e3L;
 const float__t A4 = 1.6235862515167575384252e4L;
 const float__t A5 = 2.3782041382114385731252e4L;
 const float__t A6 = 1.1819493347062294404278e4L;
 const float__t A7 = 8.8709406962545514830200e2L;

 const float__t B0 = 1.0000000000000000000e0L;
 const float__t B1 = 4.2313330701600911252e1L;
 const float__t B2 = 6.8718700749205790830e2L;
 const float__t B3 = 5.3941960214247511077e3L;
 const float__t B4 = 2.1213794301586595867e4L;
 const float__t B5 = 3.9307895800092710610e4L;
 const float__t B6 = 2.8729085735721942674e4L;
 const float__t B7 = 5.2264952788528545610e3L;
 const float__t C0    = 1.42343711074968357734e0L;
 const float__t C1 = 4.63033784615654529590e0L;
 const float__t C2 = 5.76949722146069140550e0L;
 const float__t C3 = 3.64784832476320460504e0L;
 const float__t C4 = 1.27045825245236838258e0L;
 const float__t C5 = 2.41780725177450611770e-1L;
 const float__t C6 = 2.27238449892691845833e-2L;
 const float__t C7 = 7.74545014278341407640e-4L;

 const float__t D0 = 1.4142135623730950488016887e0L;
 const float__t D1 = 2.9036514445419946173133295e0L;
 const float__t D2 = 2.3707661626024532365971225e0L;
 const float__t D3 = 9.7547832001787427186894837e-1L;
 const float__t D4 = 2.0945065210512749128288442e-1L;
 const float__t D5 = 2.1494160384252876777097297e-2L;
 const float__t D6 = 7.7441459065157709165577218e-4L;
 const float__t D7 = 1.4859850019840355905497876e-9L;

 const float__t E0 = 6.65790464350110377720e0L;
 const float__t E1 = 5.46378491116411436990e0L;
 const float__t E2 = 1.78482653991729133580e0L;
 const float__t E3 = 2.96560571828504891230e-1L;
 const float__t E4 = 2.65321895265761230930e-2L;
 const float__t E5 = 1.24266094738807843860e-3L;
 const float__t E6 = 2.71155556874348757815e-5L;
 const float__t E7 = 2.01033439929228813265e-7L;
 const float__t F0 = 1.4142135623730950488016887e0L;
 const float__t F1 = 8.482908416595164588112026e-1L;
 const float__t F2 = 1.936480946950659106176712e-1L;
 const float__t F3 = 2.103693768272068968719679e-2L;
 const float__t F4 = 1.112800997078859844711555e-3L;
 const float__t F5 = 2.611088405080593625138020e-5L;
 const float__t F6 = 2.010321207683943062279931e-7L;
 const float__t F7 = 2.891024605872965461538222e-15L;

 float__t abs_x = Abs (x);

 if (abs_x <= 0.85L)
  {
   float__t r = 0.180625L - 0.25L * x * x;
   float__t num
 ...
 float__t r = Sqrt (LN2 - Log (1.0L - abs_x));
...
double tswg[] = { 12.700, 11.786, 10.973, 10.160, 9.449,  8.839,  8.230,  7.620,  7.010,  6.401,
                  5.893,  5.385,  4.877,  4.470,  4.064,  3.658,  3.251,  2.946,  2.642,  2.337,
                  2.032,  1.829,  1.626,  1.422,  1.219,  1.016,  0.914,  0.813,  0.711,  0.610,
                  0.559,  0.5080, 0.4572, 0.4166, 0.3759, 0.3454, 0.3150, 0.2946, 0.2743, 0.2540,
...
double E24[] = { 1.0, 1.1, 1.2, 1.3, 1.5, 1.6, 1.8, 2.0, 2.2, 2.4, 2.7, 3.0, 3.3,
                 3.6, 3.9, 4.3, 4.7, 5.1, 5.6, 6.2, 6.8, 7.5, 8.2, 9.1, 10 };
double E48[] = { 1.00, 1.05, 1.10, 1.15, 1.21, 1.27, 1.33, 1.40, 1.47, 1.54, 1.62, 1.69, 1.78,
                 1.87, 1.96, 2.05, 2.15, 2.26, 2.37, 2.49, 2.61, 2.74, 2.87, 3.01, 3.16, 3.32,
                 3.48, 3.65, 3.83, 4.02, 4.22, 4.42, 4.64, 4.87, 5.11, 5.36, 5.62, 5.90, 6.19,
                 6.49, 6.81, 7.15, 7.50, 7.87, 8.25, 8.66, 9.09, 9.53, 10,   10 };
double E96[] = { 1.00, 1.02, 1.05, 1.07, 1.10, 1.13, 1.15, 1.18, 1.21, 1.24, 1.27, 1.30, 1.33, 1.37,
   ...
   if (n < args)
    {
     switch (fmt)
      {
      case tNone:
       if (dst + i < dst_end) dst += sprintf (dst, pfmt);
       break;
      case tPtr:
       if (dst + i < dst_end)
        {
...
{
 double dt = scandatatime (tstr, nullptr);
 return (int_t)dt;
}
...
double scandatatime (char *tstr, char **endp)
{
 ...
 int year = 0;
 for (int i = 0; i < 4 && isdigit (*cp); i++) year = year * 10 + (*cp++ - '0');
 ...
 int month = 0;
 while (isdigit (*cp)) month = month * 10 + (*cp++ - '0');
 ...
 int day = 0;
 while (isdigit (*cp)) day = day * 10 + (*cp++ - '0');
 ...
 if (*cp == ' ' || *cp == ',')
  {
   ...
   if (isdigit (*cp))
    {
     while (isdigit (*cp)) hour = hour * 10 + (*cp++ - '0');
     ...
     if (*cp == ':')
      {
       ...
       while (isdigit (*cp)) min = min * 10 + (*cp++ - '0');
       ...
       if (*cp == ':')
        {
         ...
         while (isdigit (*cp)) sec = sec * 10 + (*cp++ - '0');
 ...
 if (breakdown.tm_year != orig_year || breakdown.tm_mon != orig_month
     || breakdown.tm_mday != orig_day || breakdown.tm_hour != orig_hour
     || breakdown.tm_min != orig_min || breakdown.tm_sec != orig_sec)
  {
   if (endp) *endp = tstr;
   return qnan;
  }
...
uint32_t wavelength_to_rgb (float__t wavelength_m)
{
 ...
 uint32_t result
     = (uint32_t)(blue * 255) + 256 * (uint32_t)(green * 255) + 65536 * (uint32_t)(red * 255);
 return result;
}
...
// Functon returns name of the nearst color from X11 palette
void rgb_to_color_name_extended (char *str, bool pas, int_t rgb)
{
 // Extended color table X11/CSS3
 static const struct
 {
  uint32_t rgb;
  const char *name;
 ...
 const char *closestName = "Unknown";

 for (size_t i = 0; i < sizeof (colors) / sizeof (colors[0]); i++)
  {
   int r2 = (colors[i].rgb >> 16) & 0xFF;
   int g2 = (colors[i].rgb >> 8) & 0xFF;
   int b2 = colors[i].rgb & 0xFF;

   // Use weighted Euclidean distance (considering human eye perception)
   int distance = 2 * (r1 - r2) * (r1 - r2) + 4 * (g1 - g2) * (g1 - g2) + 3 * (b1 - b2) * (b1 - b2);

   if (distance < minDistance)
    {
     minDistance = distance;
     closestName = colors[i].name;
    }
  }
 strcpy (str, closestName);
 return;
}
