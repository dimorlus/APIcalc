...
Generates a WAV audio file (mono, 44100 Hz, 16-bit PCM) from a mathematical expression.
...
* **play(expr,from,to,x)**: Generates a WAV audio file from a mathematical expression.
