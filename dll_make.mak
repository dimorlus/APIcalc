...
SRCS = scalc.cpp sfmts.cpp sfunc.cpp calclib.cpp bmp.cpp files.cpp graphics.cpp matrix.cpp \
memmng.cpp output.cpp scanners.cpp script.cpp solvers.cpp sym_vars.cpp
