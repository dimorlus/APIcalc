...
void WinApiCalc::OnCreate ()
{
 ...
 m_pCalculator->addfn ("menu", (void *)(int (*) (int))MenuFunction);
 m_pCalculator->addfn ("help", (void *)(int (*) (int))HelpFunction);
 m_pCalculator->addfn ("opacity", (void *)(int (*) (int))OpacityFunction);
...
static int_t MenuFunction (int_t x)
{
 ...
 if (!g_pCalcInstance || !g_pCalcInstance->IsUIReady () || !g_pCalcInstance->GetWindowMenu ())
  {
   return 0; // Silently fail if UI not ready
  }
